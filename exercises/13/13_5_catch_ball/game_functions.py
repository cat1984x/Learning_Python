...
def create_alien(ai_settings,screen,aliens):
    ...
    alien.rect.x = randint(0,(alien.screen_rect.width - alien.rect.width))
...
def update_aliens(ai_settings,stats,screen,ship,ships,aliens,bullets):
    ...
    #检测是否抓到球
    if pygame.sprite.groupcollide(ships,aliens,False,True):
